...
public class Masa extends Fragment {
    ...
    // Constantes específicas de Masa
    private final String CATEGORY_NAME = "Conversor de Masa";
    private final String[] UNITS = {"Kilogramos", "Gramos", "Libras", "Onzas"};
    // Factores relativos al KILOGRAMO (la unidad base, factor 1.0)
    private final double[] CONVERSION_FACTORS = {1.0, 1000.0, 2.20462, 35.274};
    ...
    private void performConversion() {
        ...
        try {
            ...
            // 1. Convertir la entrada a la unidad BASE (Kilogramo)
            ...
            for (int i = 0; i < UNITS.length; i++) {
                // Convertir de Base (Kilogramo) a Destino: ValorDestino = ValorBase * FactorDestino
